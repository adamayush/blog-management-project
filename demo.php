...
<div class="w3-container w3-grey" style="position:relative">
 ...
 <h1 class="w3-jumbo w3-text-grey w3-text-shadow" style="text-align: center;">My Blog</h1>
</div>

<div class="w3-grey w3-animate-zoom" style="padding:20px 50px;background-image:url('bgsub.jpg');
  ...
  <div class="w3-twothird w3-padding-right">
    <div class="w3-card-4">
      <div class="w3-display-container">
        <img src="img2.jpg" alt="Car" style="width:60%; text-align: center;">
...
<div class="w3-card-4">
  <img src="bgbg.jpg" alt="Disc" style="width:60%">
  <div class="w3-container w3-white">
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    <p>Today</p>
...
<div class="w3-section w3-container">
<div class="w3-card-4">
  <img src="blogimg.jpg" alt="Snow" style="width:60%">
  <div class="w3-container w3-white">
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    <p>Today</p>
